...
Under traffic-based rewards (CIP-0104), rewards are calculated automatically from transaction traffic. Saxon Automate doesn't need to create activity markers. Each featured app party on a transaction receives an equal share of the app rewards generated by that transaction.
